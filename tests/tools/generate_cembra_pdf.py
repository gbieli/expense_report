...
<body>
    ...
    <table style="width:100%">
      <tr>
        <th width="80">Einkaufs-Datum</th>
        <th width="80">Verbucht am</th>
        <th width="200">Beschreibung</th>
        <th width="80">Gutschrift CHF</th>
        <th width="80">Belastung CHF</th>
      </tr>
      <tr>
        <td>02.12.2023</td>
        <td>03.12.2023</td>
...
# Generate PDF
pdf_path = "test_data/cembra/cembra_dummy.pdf"
